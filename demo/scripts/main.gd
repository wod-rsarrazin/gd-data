...
func _ready():
	...
	var heroes_ordered: Array[Hero] = heroes.values()
	heroes_ordered.sort_custom(func(a, b): return a.index < b.index)

	var races_ordered: Array[Race] = races.values()
	races_ordered.sort_custom(func(a, b): return a.index < b.index)

	var weapons_ordered: Array[Weapon] = weapons.values()
	weapons_ordered.sort_custom(func(a, b): return a.index < b.index)

	var elements_ordered: Array[Element] = elements.values()
